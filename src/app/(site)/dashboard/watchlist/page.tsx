...
export default function WatchListPage() {
  return (
    <FeaturePage
      title="Watch List"
      description="Track Stellar addresses and receive email notifications when transactions occur."
      emptyTitle="No addresses in your watch list"
      emptyDescription="Add an address to monitor incoming and outgoing transactions."
    />
  );
}
