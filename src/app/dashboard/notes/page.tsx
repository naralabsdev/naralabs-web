...
export default function TxnPrivateNotesPage() {
  return (
    <FeaturePage
      title="Txn Private Notes"
      description="Attach a private note (up to 100 characters) to transactions for easier tracking."
      emptyTitle="No transaction private notes yet"
      emptyDescription="Please DO NOT store any passwords or private keys here."
    />
  );
}
