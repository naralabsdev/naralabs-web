...
import { WebhookCard } from "@/modules/landing/components/features/webhooks/webhook-card";
import { CSSProperties } from "react";

const DEMO_WEBHOOKS: WebhookEndpointRow[] = [
  {
    id: "wh_demo_primary",
    url: "https://api.acme.co/webhooks/naralabs",
  ...
  },
  {
    ...
    url: "https://hooks.acme.co/naralabs",
  ...
  {
    id: "wh_demo_staging",
    url: "https://staging.acme.co/webhooks/naralabs",
    events: ["webhook.test"],
    enabled: 0,
