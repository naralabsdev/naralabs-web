...
import { Copy, Download } from "@/shared/ui/icons";
import { ShimmerDots } from "@/shared/ui/shimmer-dots";
import { Switch } from "@/shared/ui/switch";
import { useMediaQuery } from "@/shared/ui/hooks";
        ...
        <div>
          <div className="flex items-center justify-between gap-2">
            <div className="flex items-center gap-2">
              ...
              <CircleInfo className="size-4 text-neutral-500" />
            </div>
