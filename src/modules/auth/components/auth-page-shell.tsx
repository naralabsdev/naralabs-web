...
import {
  ...
  authPageFooterSpacerClass,
  authPageFooterTopSpacingClass,
  authPageSpaciousOffsetClass,
  ...
  return (
    <div
      className={cn(
        satoshi.variable,
        inter.variable,
        "marketing-theme font-default flex flex-col bg-white",
        !spaciousLayout && "min-h-screen",
      )}
    >
      ...
      <main
        className={cn(
          ...
          !spaciousLayout && "flex-1 justify-center py-12",
        )}
      >
        <AuthPageTransitionProvider>
          <div
            className={cn(
              authPageContainerClass,
              spaciousLayout && authPageSpaciousOffsetClass,
            )}
          >
            {children}
          </div>
      ...
      {spaciousLayout ? (
        <div className={cn("w-full shrink-0", authPageFooterSpacerClass)} aria-hidden />
      ) : null}

      <Footer
        className={spaciousLayout ? authPageFooterTopSpacingClass : undefined}
      />
    </div>
  );
}
