import { publicEnv, serverEnv } from "@/shared/config/public-env";
...
const { vercelEnv, ngrokUrl } = publicEnv;
const { vercelUrl, storageBaseUrl } = serverEnv;
...
export const PARTNERS_DOMAIN_WITH_NGROK =
  vercelEnv === "production"
    ...
    : vercelEnv === "preview"
      ? "https://partners-staging.dub.co"
      : ngrokUrl || "http://partners.localhost:8888";
...
export const R2_URL = storageBaseUrl || "https://dubassets.com";
