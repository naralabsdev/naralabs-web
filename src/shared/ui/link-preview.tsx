...
import { fetcher, getDomainWithoutWWW, getUrlFromString } from "@/shared/lib";
import { Hyperlink } from "@/shared/ui/icons/nucleo";
    ...
    <>
      {!defaultUrl && (
        <div className="relative flex items-center">
          <Hyperlink className="absolute inset-y-0 left-0 my-2 ml-3 w-5 text-neutral-400" />
          <input
            ref={inputRef}
            name="url"
            id="url"
